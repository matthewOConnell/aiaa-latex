...
\documentclass[]{aiaa-tc}% add 'draft' option to show overfull boxes
 ...
 % Define decimal-aligned tabular math mode column [dcolumn.sty]
 \newcolumntype{d}{D{.}{.}{-1}}

 % Verbatim environment defaults [fancyvrb.sty]
 \fvset{fontsize=\footnotesize,xleftmargin=2em}

 % Collect nomenclature entries defined by \nomenclature commands [nomencl.sty]
 \makeglossary
...
% $Id: template_advanced.tex,v 1.4 2004/04/03 13:48:43 kleb Exp $
